...
**Version:** 1.0
**Date:** 2026-04-22
**Author:** Dream Agent Contributors
...
| **Active Dreaming Memory** | Counterfactual verification before promoting memories to long-term storage — prevents hallucinated consolidation | ResearchGate | 2025 |
...
| **MAGMA** | Multi-graph memory with adaptive traversal policy — memories organized as multiple overlapping graphs with learned traversal | arXiv:2604.12285 | 2026 |
